...
import { BookService, BookVeterinarian } from '../../../../data/model/index';
import {Fonts} from '../../../../assets/fonts/index';
import Moment from 'moment';

type Props = {
  book?: BookVeterinarian;
  onPress(): void;
};
  ...
  return (
    <SafeAreaView style={{flex: 1, flexDirection: 'column', marginBottom: 30}}>
      <TouchableOpacity
        ...
        onPress={onPress}>
        <Image
          style={BookingVeterinarianHistoryStyles.imageItem}
          source={{uri: book?.veterinarian.image}}
        />
        <View
          style={{
            flex: 1,
          ...
          <View style={{flexDirection: 'row', marginEnd: 10}}>
            <Text
              ...
              You have booked a veterinarian {book?.veterinarian.name} from{' '}
              {Moment(book?.dateStart).format('DD/MM/yyyy')} to
              {Moment(book?.dateEnd).format('DD/MM/yyyy')}
            </Text>
          </View>
