...
import {BookingAppointment} from '../../../../data/model/index';
import {Fonts} from '../../../../assets/fonts/index';
import Moment from 'moment';

type Props = {
  book?: BookingAppointment;
  onPress(): void;
};
  ...
  return (
    <SafeAreaView style={{flex: 1, flexDirection: 'column', marginBottom: 30}}>
      <TouchableOpacity
        ...
        onPress={onPress}>
        <Image
          style={BookingAppointmentHistoryStyles.imageItem}
          source={{uri: book?.pet?.petImage?.image1}}
        />
        <View
          style={{
            flex: 1,
          ...
          <View style={{flexDirection: 'row', marginEnd: 10}}>
            <Text
              ...
              You have a meeting with {book?.pet.name} on{' '}
